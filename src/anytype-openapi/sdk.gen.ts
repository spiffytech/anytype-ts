...
import type { AddListObjectsData, AddListObjectsErrors, AddListObjectsResponses, CreateApiKeyData, CreateApiKeyErrors, CreateApiKeyResponses, CreateAuthChallengeData, CreateAuthChallengeErrors, CreateAuthChallengeResponses, CreateObjectData, CreateObjectErrors, CreateObjectResponses, CreatePropertyData, CreatePropertyErrors, CreatePropertyResponses, CreateSpaceData, CreateSpaceErrors, CreateSpaceResponses, CreateTagData, CreateTagErrors, CreateTagResponses, CreateTypeData, CreateTypeErrors, CreateTypeResponses, DeleteObjectData, DeleteObjectErrors, DeleteObjectResponses, DeletePropertyData, DeletePropertyErrors, DeletePropertyResponses, DeleteTagData, DeleteTagErrors, DeleteTagResponses, DeleteTypeData, DeleteTypeErrors, DeleteTypeResponses, GetListObjectsData, GetListObjectsErrors, GetListObjectsResponses, GetListViewsData, GetListViewsErrors, GetListViewsResponses, GetMemberData, GetMemberErrors, GetMemberResponses, GetObjectData, GetObjectErrors, GetObjectResponses, GetPropertyData, GetPropertyErrors, GetPropertyResponses, GetSpaceData, GetSpaceErrors, GetSpaceResponses, GetTagData, GetTagErrors, GetTagResponses, GetTemplateData, GetTemplateErrors, GetTemplateResponses, GetTypeData, GetTypeErrors, GetTypeResponses, ListMembersData, ListMembersErrors, ListMembersResponses, ListObjectsData, ListObjectsErrors, ListObjectsResponses, ListPropertiesData, ListPropertiesErrors, ListPropertiesResponses, ListSpacesData, ListSpacesErrors, ListSpacesResponses, ListTagsData, ListTagsErrors, ListTagsResponses, ListTemplatesData, ListTemplatesErrors, ListTemplatesResponses, ListTypesData, ListTypesErrors, ListTypesResponses, RemoveListObjectData, RemoveListObjectErrors, RemoveListObjectResponses, SearchGlobalData, SearchGlobalErrors, SearchGlobalResponses, SearchSpaceData, SearchSpaceErrors, SearchSpaceResponses, UpdateObjectData, UpdateObjectErrors, UpdateObjectResponses, UpdatePropertyData, UpdatePropertyErrors, UpdatePropertyResponses, UpdateSpaceData, UpdateSpaceErrors, UpdateSpaceResponses, UpdateTagData, UpdateTagErrors, UpdateTagResponses, UpdateTypeData, UpdateTypeErrors, UpdateTypeResponses } from './types.gen';
 ...
 */
export const createAuthChallenge = <ThrowOnError extends boolean = false>(options: Options<CreateAuthChallengeData, ThrowOnError>) => (options.client ?? client).post<CreateAuthChallengeResponses, CreateAuthChallengeErrors, ThrowOnError>({
 ...
 */
export const searchGlobal = <ThrowOnError extends boolean = false>(options: Options<SearchGlobalData, ThrowOnError>) => (options.client ?? client).post<SearchGlobalResponses, SearchGlobalErrors, ThrowOnError>({
 ...
 */
export const updateSpace = <ThrowOnError extends boolean = false>(options: Options<UpdateSpaceData, ThrowOnError>) => (options.client ?? client).patch<UpdateSpaceResponses, UpdateSpaceErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}',
    ...options,
    headers: {
 ...
 */
export const addListObjects = <ThrowOnError extends boolean = false>(options: Options<AddListObjectsData, ThrowOnError>) => (options.client ?? client).post<AddListObjectsResponses, AddListObjectsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const removeListObject = <ThrowOnError extends boolean = false>(options: Options<RemoveListObjectData, ThrowOnError>) => (options.client ?? client).delete<RemoveListObjectResponses, RemoveListObjectErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getListViews = <ThrowOnError extends boolean = false>(options: Options<GetListViewsData, ThrowOnError>) => (options.client ?? client).get<GetListViewsResponses, GetListViewsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getListObjects = <ThrowOnError extends boolean = false>(options: Options<GetListObjectsData, ThrowOnError>) => (options.client ?? client).get<GetListObjectsResponses, GetListObjectsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getMember = <ThrowOnError extends boolean = false>(options: Options<GetMemberData, ThrowOnError>) => (options.client ?? client).get<GetMemberResponses, GetMemberErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createObject = <ThrowOnError extends boolean = false>(options: Options<CreateObjectData, ThrowOnError>) => (options.client ?? client).post<CreateObjectResponses, CreateObjectErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}/objects',
    ...options,
    headers: {
 ...
 */
export const updateObject = <ThrowOnError extends boolean = false>(options: Options<UpdateObjectData, ThrowOnError>) => (options.client ?? client).patch<UpdateObjectResponses, UpdateObjectErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}/objects/{object_id}',
    ...options,
    headers: {
 ...
 */
export const searchSpace = <ThrowOnError extends boolean = false>(options: Options<SearchSpaceData, ThrowOnError>) => (options.client ?? client).post<SearchSpaceResponses, SearchSpaceErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listTypes = <ThrowOnError extends boolean = false>(options: Options<ListTypesData, ThrowOnError>) => (options.client ?? client).get<ListTypesResponses, ListTypesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createType = <ThrowOnError extends boolean = false>(options: Options<CreateTypeData, ThrowOnError>) => (options.client ?? client).post<CreateTypeResponses, CreateTypeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}/types',
    ...options,
    headers: {
 ...
 */
export const deleteType = <ThrowOnError extends boolean = false>(options: Options<DeleteTypeData, ThrowOnError>) => (options.client ?? client).delete<DeleteTypeResponses, DeleteTypeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getType = <ThrowOnError extends boolean = false>(options: Options<GetTypeData, ThrowOnError>) => (options.client ?? client).get<GetTypeResponses, GetTypeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}/types/{type_id}',
    ...options
});
 ...
 */
export const updateType = <ThrowOnError extends boolean = false>(options: Options<UpdateTypeData, ThrowOnError>) => (options.client ?? client).patch<UpdateTypeResponses, UpdateTypeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/spaces/{space_id}/types/{type_id}',
    ...options,
    headers: {
